export interface SessionState {
    targetUrl: string;
    actionHistory: Array<{ toolName: string; args: any }>;
}

export async function checkGuardrails(toolName: string, args: any, sessionState: SessionState): Promise<void> {
    ...
    if (toolName.startsWith('navigateTool')) {
        ...
        try {
            ...
            if (e.message.includes('Guardrail violation')) throw e;
